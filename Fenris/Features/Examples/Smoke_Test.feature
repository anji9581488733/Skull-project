Feature: Smoke_Test
    ...
    @Android
    @iOS
    Scenario: Smoke test for Gandalf with hearing instruments connected - TC 1618936 (Test case runs in connected mode and tests a flow of selected app features for smoke testing)
